...
int herofand_test_policy(void) {
    ...
    assert(herofand_curve_tier(&config.intake_curve, 45000) == 0);
    assert(herofand_curve_tier(&config.intake_curve, 60000) == 1);
    assert(herofand_curve_tier(&config.intake_curve, 80000) == 3);
